          ...
          <?php for ($i=0;$i<$array_length;$i++) {   ?>
            <li>
                <div class="current_list">
                    ...
                    <?php if($current_stats->cleansheets){ ?>
                    <h4><?php echo $current_stats->cleansheets[$i];?></h4>
                  <?php }else{?>
                    <h4>-</h4>
                  <?php } ?>
                </div>
           ...
           <?php for ($i=0;$i<$array_length;$i++) { ?>
            <li>
                <div class="current_list">
                    ...
                    <?php if($current_stats->goals_conceded){ ?>
                    <h4><?php echo $current_stats->goals_conceded[$i];?></h4>
                  <?php }else{ ?>
            <h4><?php echo $current_stats->goals_conceded[$i];?></h4>
                  <?php } ?>
                </div>
  ...
  <?php if(!$club_stats_mins_decode){ ?>
        ...
        <ul class="current_season_list">
            ...
            <li>
                <div class="current_list">
                    ...
                    <?php if($current_stats->yellow_cards[$i]){?>
                    <h4><span></span><?php echo $current_stats->yellow_cards[$i]; ?></h4>
                  <?php }else{?>
                   <h4><span></span>-</h4>
          ...
          <?php for ($i=0;$i<$array_length;$i++) { ?>
            <li>
                <div class="current_list">
                    ...
                    <?php if($current_stats->red_cards[$i]){?>
                    <h4><span></span><?php echo $current_stats->red_cards[$i]; ?></h4>
                  <?php }else{?>
                  <h4><span></span>-</h4>
                <?php } ?>
        ...
        <ul class="current_season_list">
            ...
            <li>
                <div class="current_list">
                    ...
                    <?php if($clubs_object->cleansheets[$i]){?>
                    <h4><?php echo $clubs_object->cleansheets[$i];?></h4>
                  <?php }else{?>
                    <h4>-</h4>
                  <?php } ?>
                </div>
        ...
        <ul class="current_season_list">
            ...
            <li>
                <div class="current_list">
                    ...
                    <?php if($clubs_object->goals_conceded[$i]){ ?>
                    <h4><?php echo $clubs_object->goals_conceded[$i];?></h4>
                  <?php }else{?>
                    <h4>-</h4>
                  <?php } ?>
                </div>
    ...
    <div class="current_season alignment_settings">
      ...
      <ul class="current_season_list append_li" id="get_history_li">
        ...
        <div class="current_season_flex four_cards national_team golkipper_team">
    <div class="current_season">
        <div class="current_season_head">
            <!-- <div class="current_season_img">
                <img src="img/logo1.png" alt="">
      ...
      <ul class="current_season_list append_li" id="append_debut_lis">
            <li>
                <div class="current_list">
                    ...
                    <h4><?php echo $national_team_name; ?></h4>
                </div>
            </li>
