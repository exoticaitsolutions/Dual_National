...
if(!empty($subscriptions)) {
  $alt = false;
  // foreach ($subscriptions as $key => $value11) {
  //   $user = wp_get_current_user();
  //   $roles = ( array ) $user->roles;
   
  //   if($value11->status =='pending' ||$roles[0] != 'administrator'){
  //     // echo "Asdsadsad";die;
  //     $mepr_user = new MeprUser( $user_ID );
  //     if( $mepr_user->is_active() ) {
  //     //  header('Location: https://18.188.169.10/my-account/');exit;
  //   }else {
  //     if (wp_delete_user($user_ID)) {
  //       // header('Location: https://www.makemytrip.com/flights/');exit;
  //       header('Location:'.site_url('plans-pricing'));exit;
...
<div class="mp_wrapper">
    ...
    <div class="mmbrship_title">
      <h2>Update or Cancel Membership</h2>
        </div>
...
<!--                         <a href="<?php //echo "/account/?action=resume&sub=$s->id"; ?>"
                        ...
                        <a href="/upgrade-membership/"  class="modify_btn">Modify</a>
                ...
                <li>
                  <div class="pyment_credit_upcard">
              ...
              <?php } ?>
                    ...
                    <div class="payment-content card_pay"><a
                            href="/account/?action=update&sub=<?php echo $s->id; ?>"><img
                                src="https://dualnationalsstagiing.exoticaitsolutions.com/wp-content/uploads/2023/03/card.png">Update
                            CC</a> </div>
...
<?php
  ...
  ?>
<h1 class="Not_member">Sorry You dont have any subscription </h1>
