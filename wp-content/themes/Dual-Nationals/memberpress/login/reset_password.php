...
if ( isset( $_POST['wp-submit'] ) && $_POST['wp-submit'] ) {
    $mepr_user_password = $_POST['mepr_user_password'];
    $mepr_user_password_confirm = $_POST['mepr_user_password_confirm'];
    if($mepr_user_password != $mepr_user_password_confirm){
        $response = array( "type" => "error", "message" => "Password and Confirm password doesn't matched" );
    }
            ...
            <div class="mp-form-row mepr_password_confirm">
                <div class="mp-form-label">
                    ...
                    <div class="mp-hide-pw">
                        ...
                        <span class="error" id="mepr_user_password_confirm-error"></span>
                        <?php if(!empty($response)) { ?>
                            <span class="error" id="mepr_user_password_confirm-error"><?php echo $response["message"]; ?></span>
    <?php }?>
