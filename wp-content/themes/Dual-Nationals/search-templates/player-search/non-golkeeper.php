...
<input type="hidden" id="anPageName" name="page" value="goalkeeper" />
                              ...
                              <div class="data">
                                ...
                                <?php } else{ ?>
                                  <div class="x2nd-nationality">
                                    <div class="x2nd-nationality-1 poppins-normal-white-12px">Nationality (National Team)
                                    </div>
                                    <div class="frame-344">
                                      <div class="frame-34">
                                  ...
                                  <div class="debut">
                                    ...
                                    <div class="frame-344">
                                      <div class="frame-34">
                                        <div class="date-2 valign-text-middle date-9 poppins-medium-white-16px"><?php echo $national_team_stats[0]; ?>
                                        </div>
                                      </div>
                                    </div>
                                  </div>
                                  <div class="caps">
                                    ...
                                    <div class="frame-344">
                                      <?php if($caps){?>
                                        <div class="frame-34">
                                          <div class="address-2 valign-text-middle poppins-medium-white-16px"><?php echo $caps ?> Appearances
                                          </div>
                                        </div>
                                      <?php } ?>
                                    </div>
                                  ...
                                  <div class="intl-goalss hiddens">
                                    <div class="international-goals poppins-normal-white-12px">International Goals
                                    </div>
                                    <div class="frame-344">
                                      <?php if($international_goals){ ?>
                                        <div class="frame-34">
                                          <div class="address-2 valign-text-middle poppins-medium-white-16px"><?php echo $international_goals;?> Goals
                                          </div>
                                        </div>
                                      <?php }else{ ?>
                                        <div class="frame-34">
                                          <div class="address-2 valign-text-middle poppins-medium-white-16px">Null
                                          </div>
                                        </div>
                                      <?php } ?>
                                    </div>
                              ...
                              <div class="flex-col-item flex-col-2">
                                ...
                                <div class="data">
                                  <div class="agent-name agent">
                                    ...
                                    <?php if($agency_names){?>
                                      <div class="add-3 valign-text-middle poppins-medium-white-16px"><?php echo $agency_names;?>
                                      </div>
                                      <?php } else{?>
                                        <div class="frame-344">
    ...
    <div class="current_season">
        ...
        <ul class="current_season_list">
          <?php foreach ($current_seasons_stats_goal_decode as $current_goals_conceded_decodes) { ?>
            <li>
                <div class="current_list">
                    <div class="current_list_img">
    ...
    <div class="current_season">
        ...
        <ul class="current_season_list">
           <?php foreach ($current_seasons_stats_decode as $key => $current_concded_data) { ?>
            <li>
                <div class="current_list">
                    <div class="current_list_img">
                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/icon---assist.svg" alt="">
                    </div>
                    <?php if($current_concded_data){ ?>
                    <h4><?php echo $current_concded_data;?></h4>
                  <?php }else{ ?>
            <h4><?php echo $current_concded_data;?></h4>
                  <?php } ?>
                </div>
            ...
            <li>
                <div class="current_list">
                    <div class="current_list_img">
                       ...
                       <h4>12<?php //echo $club_stats_mins_decodes; ?></h4>
    ...
    <div class="current_season">
        ...
        <ul class="current_season_list">
            <?php foreach ($club_stats_appeara_decoded as $key => $club_stats_appearances_data) { ?>
            <li>
                <div class="current_list">
                    <div class="current_list_img">
                        <img class="qute_green" src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/formation-filled.svg" alt="">
    ...
    <div class="current_season">
        ...
        <ul class="current_season_list">
            <?php foreach ($current_goals_conceded_decode as $current_goals_conceded_decodes) { ?>
            <li>
                <div class="current_list">
                    <div class="current_list_img">
                        <img  class="qute_greens" src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/icon---match-14.svg" alt="">
    ...
    <div class="current_season curr_yellow">
        ...
        <ul class="current_season_list">
            <?php foreach ($club_stats_assists_decode as $key => $current_concded_data) { ?>
            <li>
                <div class="current_list">
                    <div class="current_list_img">
                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/icon---assist.svg" alt="">
  ...
  <div class="current_season_flex four_cards">
    ...
    <div class="current_season">
        ...
        <ul class="current_season_list li_counts" id="li_countss_debut">
            ...
            <?php $counts = 0;
             foreach($national_team_stats as $national_team_statss){
              $counts++;
              ?>
    ...
    <div class="current_season">
        ...
        <ul class="current_season_list">
           ...
           <?php foreach ($national_team_stats_goals as $current_goals_conceded_decodes) { ?>
            <li>
                <div class="current_list">
                    <div class="current_list_img">
...
jQuery('#rest_positions2').on('click', function() {
  var main_positions =  jQuery('#rest_positions').val();
  var selectedOption = jQuery(this).val();
 jQuery(jQuery("#rest_positions3 option[value='"+main_positions+"']")).remove();
     jQuery(jQuery("#rest_positions2 option[value='"+main_positions+"']")).remove();
