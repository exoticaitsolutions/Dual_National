...
get_header('new');
/**
 * Template Name: User Profile ddd
 *
...
// echo '<pre>'; print_r($subscriptions);die;
 ...
 //foreach($txn as $tx){
if( function_exists( 'mepr' ) && !empty( $mepr_current_user = MeprUtils::get_currentuserinfo() ) ) {
    $membership = $mepr_current_user->active_product_subscriptions();
    if( !empty( $membership ) ) {
        $membership_name = $membership[0]->product()->post_title;
        // Do something with $membership_name
...
window.location.href = "https://dualnationals.com/my-account";
}, 1000);
...
$mepr_agency_name = $_POST['mepr_agency_name'];
$mepr_agent_name = $_POST['mepr_agent_name'];
$mepr_agent_phone = $_POST['mepr_agent_phone'];
$mepr_agent_email = $_POST['mepr_agent_email'];
...
$mepr_agency_name = update_user_meta( $user_id, 'mepr_agency_name', $mepr_agency_name );
$mepr_agent_name = update_user_meta( $user_id, 'mepr_agent_name', $mepr_agent_name );
$mepr_agent_phone = update_user_meta( $user_id, 'mepr_agent_phone', $mepr_agent_phone );
$mepr_agent_email = update_user_meta( $user_id, 'mepr_agent_email', $mepr_agent_email );
...
<section class="my_account_sec">
    ...
    <form id="contactForm1s" method="post" enctype="multipart/form-data">
        ...
        <div class="profiel_details edit_profiel_details bg_style"
            style="background-image: url('<?php echo get_stylesheet_directory_uri(); ?>/assets/img/my_account_bg.png');margin-top: -139px;">
            <div class="container">
            <div id="append_data"> </div>
                ...
                <div class="row">
                        ...
                        <div class="profiel_details_crd">
                            ...
                            <div class="edit_profiles">
                                ...
                                <input type="text" class="max_state" name="first_name"
                                    value="<?php echo esc_attr(get_the_author_meta('display_name', get_current_user_id())); ?>">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 mb-3">
                        ...
                        <div class="profiel_details_crd">
                            ...
                            <div class="edit_profiles">
                                ...
                                <input type="tel" id="mobile" name="mepr_phone_number"
                                    value="<?php echo get_user_meta(get_current_user_id(),'mepr_phone_number',true); ?>"maxlength="10">
                    ...
                    <div class="col-md-4 mb-3">
                        <div class="profiel_details_crd">
                            <h6>Billing Info</h6>
                            <?php  // if($result !=='Free Membership'){ ?>
                                <!--  <a href="<?php echo site_url('plans-pricing');?>"><img
                                    src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/edit.png"
                                    alt="" />Credit Card</a> -->
                            <!-- <a href="/plans-pricing/"><img
                                    src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/edit.png"
                                    alt="" />Other Payment</a> -->
                    <a href="/account/?action=subscriptions" class=""><img
                                    src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/edit.png"
                                    alt="" />Update CC Or Cancel Subscription</a>
                            <?php /*}else{
                    ...
                    <div class="col-md-4 mb-3">
                        <div class="profiel_details_crd">
                            <a href="/upgrade-membership/"> <h6>Upgrade Membership</h6>
                                <?php echo $result;?>
                           </a>
                        </div>
                </div>
                ...
                <div class="edit_profiel_btn text-center">
                   <!--  <a href="/account/?action=subscriptions" class="theme_btn cancel_btn">Cancel Subscriptions</a> -->
                    <input type="submit" class="theme_btn" name="update_user_profile" value="Save Changes">
                </div>
...
<script>
    ...
    jQuery('#watch_list_data').DataTable();
        ...
        jQuery("#mepr_agent_phone").attr('maxlength','10');

             setTimeout(function () {

    var state_name_list = jQuery('#state_name_list').val();
jQuery("#state option:nth-child(1)").text(state_name_list);
jQuery("#state option:nth-child(1)").val(state_name_list);
