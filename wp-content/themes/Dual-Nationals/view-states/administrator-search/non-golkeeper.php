          ...
          <div class="flex-col">
            ...
            <?php } ?>
              ...
              <div class="flex-col-1 flex-col-2 ms-auto">
                  ...
                  </div> <?php echo do_shortcode('[addtoany]'); ?>
                  </span>
                </div>
                  <?php     global $wpdb;
                  ...
                  <div class="tooltip tooltip_dots">
                    ...
                    <span class="tooltiplink">
                      <form method="post"> <a   href="">Contact Player</a>
              ...
              <div class="data">
                ...
                <div class="agent-name agent">
                  ...
                  <div class="frame-344">
                    ...
                    <div class="frame-34">
                      <div class="name-3 valign-text-middle name-4 poppins-medium-white-16px">Jorge Mendes</div>
                    </div>
