 ...
 -->
                                ...
                                <div class="mepr-product-rows">
                                    ...
                                    <div style="display:block;"
                                        ...
                                        <!-- <a id="remove_coupens" href="javascript:void(0)">Remove</a> -->
                                        <a id="reset" href="javascript:void(0)">Reset Coupan</a>
...
jQuery(document).ready(function() {
    document.getElementById('reset').onclick= function() {
        var field= document.getElementById('mepr_coupon_code1');
        field.value= field.defaultValue;
        jQuery("span.cc-error.coupens_error").css("display", "none", "!important");

    };
    // jQuery("#user_first_name1").focus(function(Event) {
    jQuery(document).on("keypress focus ", "#user_first_name1", function() {
        console.log('asdsadsad');
        jQuery("span.cc-error.first_names").css("display", "none", "!important");
    });
    jQuery(document).on("focusout", "#user_first_name1", function() {
        if (first_name == '') {
    ...
    jQuery(document).on("keypress focus ", "#user_last_name1", function() {
        jQuery("span.cc-error.last_names").css("display", "none", "!important");
    });
    jQuery(document).on("keypress focus ", "#mepr_phone_number1", function() {
        jQuery("span.cc-error").css("display", "none", "!important");
    });
    //     jQuery("#hide_copenss").click(function(e){
    // e.preventDefault();
    //     jQuery('.mepr_coupon').toggle();
    //    // jQuery('a#hide_copenss img').hide();
    // });
    jQuery(document).on("keypress", "#user_first_name1,#user_last_name1,#mepr-address-city,.mepr-states-text",
        function() {
    ...
    jQuery(".mepr-submit").click(function() {
        ...
        var user_email1 = jQuery('#user_email1').val();
        if (user_email1 == '') {
            jQuery('.mp-form-row.mepr_email.mepr-field-required .cc-error ').text(
                'Email is Required');
    ...
    jQuery('#mepr_phone_number1').attr("placeholder", "9876543210");
    jQuery('.payment-option-paypalcommerce').prepend(
        '<img id="theImg" src="https://dualnationalsstagiing.exoticaitsolutions.com/wp-content/plugins/memberpress/images/checkout/paypal.png" />'
    );
    jQuery('.payment-option-stripe').prepend(
        '<img src="https://dualnationalsstagiing.exoticaitsolutions.com/wp-content/plugins/memberpress/images/cards.png">'
    );
