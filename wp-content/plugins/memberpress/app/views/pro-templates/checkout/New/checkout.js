(function($) {
  $(document).ready(function() {
    jQuery('.mepr-checkout-form [data-numeric]').payment('restrictNumeric');
    jQuery('.mepr-checkout-form .cc-number').payment('formatCardNumber');
    jQuery('.mepr-checkout-form .cc-exp').payment('formatCardExpiry');
    jQuery('.mepr-checkout-form .cc-cvc').payment('formatCardCVC');

    jQuery('body').on('click', '.mepr-checkout-form .mepr-submit', function (e) {
