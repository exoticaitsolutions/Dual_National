...
class MeprStripeGateway extends MeprBaseRealGateway {
  ...
  */
  ...
  public function display_update_account_form($sub_id, $errors=array(), $message='') {
    ...
    <div class="back_btn">  <button onclick="history.go(-1);"><img src="https://dualnationalsstagiing.exoticaitsolutions.com/wp-content/uploads/2023/03/back-btn.png"> Back</button></div>
          ...
          <div class="mepr_update_account_table">
            ...
            <?php else : ?>
              ...
              <?php 
                    ...
                    $fech_players_data = $wpdb->get_row("SELECT cc_last4  FROM $table where user_id=".$user_ID."");
                    //echo "<pre>";
                    //print_r($fech_players_data);die;
                    
                    if($fech_players_data){?>
                      <!-- <p></p> -->
                      <p>Current Card Detail : XXXX-XXXX-XXXX-<?php echo $fech_players_data->cc_last4; ?></p>
                    <?php }?>
            <?php endif; ?>
            ...
            <div class="mepr_spacer"> </div>
           <div class="cart-update-btn"> <input type="submit" class="mepr-submit" value="<?php echo esc_attr(_x('Update Details', 'ui', 'memberpress')); ?>" /></div>
            <img src="<?php echo esc_url(admin_url('images/loading.gif')); ?>" alt="<?php esc_attr_e('Loading...', 'memberpress'); ?>" style="display: none;" class="mepr-loading-gif" />
