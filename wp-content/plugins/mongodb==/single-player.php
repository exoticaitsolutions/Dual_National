...
get_header();?>
    ...
    <link rel="stylesheet" href="https://dualnationals.com/wp-content/themes/Dual-Nationals/assets/css/goalkeeper.css?" />
    <link rel="stylesheet" href="https://dualnationals.com/wp-content/themes/Dual-Nationals/assets/css/globals.css" />
    <link rel="stylesheet" href="https://dualnationals.com/wp-content/themes/Dual-Nationals/assets/css/styleguide.css" />
<style>
   body{  margin: 0px;
...
$second_flag =$citizen_flag[1];
 ...
 $club_length = sizeof($clubs_object->clubs); //  Competions Array
  ...
  $current_user = wp_get_current_user();
   $mepr_agency_name = get_user_meta($current_user->ID,'mepr_agency_name',);
   $mepr_agent_name = get_user_meta($current_user->ID,'mepr_agent_name',); 
   $mepr_agent_phone = get_user_meta($current_user->ID,'mepr_agent_phone',); 
   $mepr_agent_email = get_user_meta($current_user->ID,'mepr_agent_email',); 
 ...
 ?>
          ...
          <div class="flex-col">
            ...
            <?php } ?>
              ...
              <div class="flex-col-1 flex-col-2 ms-auto">
                  ...
                  <span class="tooltiptext">
                    ...
                    <button class="clipboard fa fa-clone clipboard"></button> <?php echo do_shortcode('[addtoany]'); ?>
                  </div>
                  </span>
                </div>
                  <?php     global $wpdb;
                  ...
                  <div class="save_favrt" id="save_favrt" wishlist_exit="" wishlist_id = "<?php echo $fech_players_data->id;?>">
                          ...
                          <img id="my_image" src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/heart-11.svg"
                                alt="">
                        </div>
                         <?php
                        }else{
                        ...
                        <div class="save_favrt" id="save_favrt" wishlist_exit="false" wishlist_id = "">
                            ...
                            <input type="hidden" name="current_user_id" id="current_user_id"
                                value="<?php echo get_current_user_id(  );?>">
                                <input type="hidden" name="image_url" id="image_url"
                                value="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/heart-11.svg">
                            <img id="my_image"
                  ...
                  <div class="tooltip tooltip_dots">
                    ...
                    <span class="tooltiplink">
                       <a href="<?php echo $filename;?>">Download CSV</a>
            ...
            <div class="flex-col-item flex-col-2">
              <div class="x-info">
                ...
                <img class="edit-2-2" src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/edit-2-2.svg" alt="edit-2" />
              </div>
              <div class="data">
                ...
                <div class="agency">
                  ...
                  <div class="frame-34">
                    <!-- <img class="plus-circle-3" src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/plus-circle.svg" alt="plus-circle"> -->
                    <div class="add-3 valign-text-middle poppins-medium-white-16px"><?php echo $agency_name ?></div>
                  </div>
                </div>

                <div class="agent-name agent">
                  <div class="agent-name-1 poppins-normal-white-12px">Agency</div>
                  <div class="frame-344">
                    
                    <div class="frame-34">
                      <div class="name-3 valign-text-middle name-4 poppins-medium-white-16px"><?php echo  $agency_agency; ?></div>
                    </div>
    ...
    <div class="current_season">
        <div class="current_season_head">
            <div class="current_season_img">
                <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/club-logo-1.svg" alt="">
            </div>
    ...
    <div class="current_season ">
        ...
        <ul class="current_season_list">
            <?php for ($i=0;$i<$array_length;$i++) {   $second_yellow_cards = $current_stats->second_yellow_cards[$i];  ?>
            <li>
                <div class="current_list">
                    <div class="current_list_img">
                    ...
                    <h4><?php echo $second_yellow_cards; ?></h4>
